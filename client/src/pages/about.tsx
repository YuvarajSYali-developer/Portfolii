...
import { personalInfo, skills, certifications, education, languages } from "@/data/portfolio-data";
                ...
                <CardContent className="p-6 h-full flex flex-col">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-heading font-semibold mb-1 leading-snug" data-testid={`cert-${cert.id}`}>
                        {cert.name}
                      </h3>
                      ...
                      {cert.link && (
                        <a
                          ...
                          className="flex items-center gap-1.5 text-xs font-medium text-primary hover:underline mt-2"
                        >
                          View Certificate
          ...
          <Card className="bg-card/50">
            <CardContent className="p-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {languages.map((lang) => (
                  <Badge key={lang.language} variant="outline" className="text-sm">
