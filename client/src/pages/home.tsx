      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 md:px-8 pt-16">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center space-y-8">
            ...
            {/* Stats */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 max-w-3xl mx-auto mt-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-700">
